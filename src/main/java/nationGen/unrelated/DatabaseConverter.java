...
public class DatabaseConverter {
	...
	public static void main(String[] args) throws IOException
	{
		...
		base.saveToFile("resources/db_conversion/output_weapon.csv");
		...
		base.saveToFile("resources/db_conversion/output_armor.csv");
	...
	{
		List<String> fileLines = FileUtil.readLines(fname);
		fileLines.remove(0);
