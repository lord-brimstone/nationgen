...
public class PreviewGenerator {
	...
	private Dimension getDimension(Unit u) throws IOException
	{
		BufferedImage base;
		String mountslot = u.getMountOffsetSlot();
		if(u.slotmap.get(mountslot) != null)
		{
			base = FileUtil.readImage(u.slotmap.get(mountslot).sprite);
		}
		else if (u.slotmap.get("basesprite").sprite != null)
		{
			base = FileUtil.readImage(u.slotmap.get("basesprite").sprite);
		}
		else
		{
